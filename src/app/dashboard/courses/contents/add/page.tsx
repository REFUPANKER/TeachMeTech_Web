...
export default function AddContent() {
    ...
    return (
        <div className='d-flex flex-col w-100'>
            ...
            <div className="w-100 d-flex flex-col lg:flex-row">
                <div className='w-100 d-flex flex-column items-center'>
                    <div className='h-[53vh] md:h-[60vh] lg:h-[75vh] w-100 overflow-auto d-flex flex-column gap-y-3'>
                        {content.map((e, i) => (
                            <div
                                key={i}
                                draggable
